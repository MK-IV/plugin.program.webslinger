...
def Website_1(): #Mode 1
    ...
    if myplatform == 'android':
        os.system('am start -a android.intent.action.VIEW -d '+ADDON.getSetting('url_1')) 
    else:   
...
def Website_2(): #Mode 2
    ...
    print "Platform: " + str(myplatform)
    if myplatform == 'android':
        os.system('am start -a android.intent.action.VIEW -d '+ADDON.getSetting('url_2')) 
    else:   
...
def Website_3(): #Mode 3
    ...
    print "Platform: " + str(myplatform)
    if myplatform == 'android':
        os.system('am start -a android.intent.action.VIEW -d '+ADDON.getSetting('url_3')) 
    else:   
...
def Website_4(): #Mode 4
    ...
    print "Platform: " + str(myplatform)
    if myplatform == 'android':
        os.system('am start -a android.intent.action.VIEW -d '+ADDON.getSetting('url_4')) 
    else:   
...
def Website_5(): #Mode 5
    ...
    print "Platform: " + str(myplatform)
    if myplatform == 'android':
        os.system('am start -a android.intent.action.VIEW -d '+ADDON.getSetting('url_5')) 
    else:   
...
def Website_6(): #Mode 6
    ...
    print "Platform: " + str(myplatform)
    if myplatform == 'android':
        os.system('am start -a android.intent.action.VIEW -d '+ADDON.getSetting('url_6')) 
    else:   
...
def Website_7(): #Mode 7
    ...
    print "Platform: " + str(myplatform)
    if myplatform == 'android':
        os.system('am start -a android.intent.action.VIEW -d '+ADDON.getSetting('url_7')) 
    else:   
...
def Website_8(): #Mode 8
    ...
    print "Platform: " + str(myplatform)
    if myplatform == 'android':
        os.system('am start -a android.intent.action.VIEW -d '+ADDON.getSetting('url_8')) 
    else:   
...
def Website_9(): #Mode 9
    ...
    print "Platform: " + str(myplatform)
    if myplatform == 'android':
        os.system('am start -a android.intent.action.VIEW -d '+ADDON.getSetting('url_9')) 
    else:   
...
def Website_10(): #Mode 10
    ...
    print "Platform: " + str(myplatform)
    if myplatform == 'android':
        os.system('am start -a android.intent.action.VIEW -d '+ADDON.getSetting('url_10')) 
    else:   
